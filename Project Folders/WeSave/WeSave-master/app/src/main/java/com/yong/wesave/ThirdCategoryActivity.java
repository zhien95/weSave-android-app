...
public class ThirdCategoryActivity extends WeSaveActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView thirdCategoryLabel = (TextView) findViewById(R.id.thirdCategoryLabel);
        thirdCategoryLabel.setText(getIntent().getStringExtra("subcat_name"));
        ...
        adapter = new CategoryAdapter(this, R.layout.list_thirdcategory, categories, "ViewCategory");
