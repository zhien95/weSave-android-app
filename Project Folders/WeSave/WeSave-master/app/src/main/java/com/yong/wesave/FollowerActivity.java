...
public class FollowerActivity extends WeSaveActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.replaceContentLayout(R.layout.activity_follower, R.id.content_frame);
        super.replaceTitle(R.string.title_follows);

        lv = (ListView) findViewById(R.id.list_view);
        emptyText = (TextView) findViewById(android.R.id.empty);
        item_id = String.valueOf(getIntent().getIntExtra("item_id", 0));
        user_json = getFollowers();
